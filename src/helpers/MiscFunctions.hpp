...
float                               vecToRectDistanceSquared(const Hyprutils::Math::Vector2D& vec, const Hyprutils::Math::Vector2D& p1, const Hyprutils::Math::Vector2D& p2);
void                                logSystemInfo();
std::string                         execAndGet(const char*);
int64_t                             getPPIDof(int64_t pid);
std::expected<int64_t, std::string> configStringToInt(const std::string&);
Hyprutils::Math::Vector2D           configStringToVector2D(const std::string&);
